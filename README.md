...
**Status: early scaffolding, under active development. Not yet functional.** See
[`clann-mag-explorer-brief.md`](clann-mag-explorer-brief.md) for the full design brief and
[`docs/phase1-investigation.md`](docs/phase1-investigation.md) for the current Phase 1 plan.
...
src/model/                     Core data model (FASTA index, contig stats, taxonomy tree, bin reconciliation,
                                marker-gene search)
